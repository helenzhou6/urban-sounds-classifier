...
from utils import get_device, init_wandb, clear_gpu_cache
...
class AudioSpectrogramDataset(Dataset):
    ...
    def __getitem__(self, idx):
        ...
        if 'spectrogram' in item:
            ...
            return item['spectrogram'], item['classID']
        else:
...
def train_one_epoch(model, dataloader, optimizer, device):
    ...
    for _, (inputs, labels) in enumerate(tqdm(dataloader, desc="Training", leave=False)):
...
def main():
    ...
    fold_values = np.load("data/fold_values.npy")
    ...
    run_k_fold_training(dataset=dataset,
                        num_folds=num_folds,
                        num_classes=num_classes,
                        epochs=epochs,
                        batch_size=batch_size,
